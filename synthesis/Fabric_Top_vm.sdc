# Written by Synplify Pro version mapact, Build 2461R. Synopsys Run ID: sid1564758679 
# Top Level Design Parameters 

# Clocks 
create_clock -period 10.000 -waveform {0.000 5.000} -name {FCCC_C0_FCCC_C0_0_FCCC|GL0_net_inferred_clock} [get_pins {FCCC_0/FCCC_C0_0/CCC_INST/GL0}] 
